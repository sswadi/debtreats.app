...
**Debtreats** is a Flask server-rendered expense tracking app built as a step-by-step learning project. Students implement features incrementally across defined steps.
